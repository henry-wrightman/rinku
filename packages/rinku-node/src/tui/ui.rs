...
fn draw_tabs(frame: &mut Frame, app: &App, area: Rect) {
    ...
    frame.render_widget(
        tabs,
        Rect::new(inner[1].x, inner[0].y + 1, inner[1].width, 1),
    );
}
...
fn draw_dashboard(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let finalized = format!(
        ...
        if app.network_stats.total_transactions > 0 {
            app.network_stats.finalized_count as f64 / app.network_stats.total_transactions as f64
                * 100.0
        } else {
            0.0
        }
    ...
    let summary_text = vec![Line::from(vec![
        ...
        Span::styled(
            format!("{}", app.dag_stats.tip_count),
        ...
        Span::styled(
            format!("{:.4} RKU", app.network_stats.total_burned),
...
fn draw_network(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let stats_items = vec![
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{}", app.network_stats.peer_count),
                Style::default().fg(Color::White),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{:.2}", app.network_stats.tps),
                Style::default().fg(Color::Cyan),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{}", app.network_stats.total_transactions),
                Style::default().fg(Color::White),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{}", app.network_stats.finalized_count),
                Style::default().fg(Color::Green),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{}", app.network_stats.pending_count),
                Style::default().fg(Color::Yellow),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("#{}", app.network_stats.checkpoint_height),
        ...
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{:.6} RKU", app.network_stats.gas_price),
                Style::default().fg(Color::Red),
            ),
        ])),
        ListItem::new(Line::from(vec![
            ...
            Span::styled(
                format!("{:.6} RKU", app.network_stats.total_burned),
                Style::default().fg(Color::Red),
            ),
        ])),
    ];
...
fn draw_validator(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let help_text = vec![
        ...
        Line::from(Span::styled(
            format!(
                "  Minimum stake: {} RKU",
                app.validator_stats.config.min_stake_amount as u64
            ),
            Style::default().fg(Color::Yellow),
        )),
        Line::from(Span::styled(
            format!(
                ...
                app.validator_stats.config.unbonding_period_days
            ),
            Style::default().fg(Color::Yellow),
        )),
    ];
...
fn draw_logs(frame: &mut Frame, app: &App, area: Rect) {
    ...
    let start = app
        .scroll_offset
        .min(app.logs.len().saturating_sub(max_display));
